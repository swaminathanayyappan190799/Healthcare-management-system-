...
<html>
<head>
	<title>Department of Neurology</title>
	<style>
		table{
...
<body>
	<br>
	<br>
	<p1 style="font-family:cursive;"><center><b><u>Department of Neurology</u></b></center></p1>
	<br>
	<br>
	<hr>
	<br>
...
$sql="SELECT firstname,lastname,UG,PG,branch,mobilenumber,email,city,zipcode,state,country,gender,username,password from doctor where branch='neurology' ";
