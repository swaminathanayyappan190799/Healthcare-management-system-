...
<html>
<head>
	<title>Department of Obsetritics and gynecology</title>
	<style>
		table{
...
<body>
	<br>
	<br>
	<p1 style="font-family:cursive;"><center><b><u>Department of Obsetritics and gynecology</u></b></center></p1>
	<br>
	<br>
	<hr>
	<br>
...
$sql="SELECT firstname,lastname,UG,PG,branch,mobilenumber,email,city,zipcode,state,country,gender,username,password from doctor where branch='Obsetritics&gynecology' ";
